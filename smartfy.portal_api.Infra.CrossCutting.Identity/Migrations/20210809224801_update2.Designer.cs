...
namespace smartfy.portal_api.Infra.CrossCutting.Identity.Migrations
{
    ...
    [Migration("20210809224801_update2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smartfy.portal_api.domain.Entities.Departamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("smartfy.portal_api.domain.Entities.TipoVeiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Tipo_de_veículo");
                });

            modelBuilder.Entity("smartfy.portal_api.domain.Entities.Veiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("smartfy.portal_api.domain.Entities.Funcionario", b =>
                {
                    b.HasOne("smartfy.portal_api.domain.Entities.Departamento", "Departamento")
                        .WithMany()
            ...
            modelBuilder.Entity("smartfy.portal_api.domain.Entities.Veiculo", b =>
                {
                    b.HasOne("smartfy.portal_api.domain.Entities.TipoVeiculo", "TipoVeiculo")
                        .WithMany()
